...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            //un message Toast est affiché pour informer l'utilisateur que cette fonctionnalité n'est pas encore disponible
            ...
            // Afficher les informations sur l'équipe
            Toast.makeText(this, "À propos de nous - Fonctionnalité à venir", Toast.LENGTH_SHORT).show();
